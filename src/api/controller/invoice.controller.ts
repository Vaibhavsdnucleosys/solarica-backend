  ...
  interface ConvertTaxInvoiceRequest {
...
export const convertToTaxInvoice =
    async (
        req: Request,
        res: Response
    ) => {
        ...
        try {
            ...
            const result =
                await convertToTaxInvoiceModel(
            ...
            await createNotificationModel(
                ...
                `Invoice ${result.invoiceNumber} converted to Tax Invoice.`,
...
export const downloadTaxInvoice = async (
  ...
  try {
    ...
    console.log(
      `[DownloadTaxInvoice] Generating TAX PDF for ${invoice.invoiceNumber}`
    );

    /*
    =========================================
    FORCE TAX INVOICE FORMAT
    =========================================
    */
    ...
    */
    ...
    res.setHeader(
      "Content-Disposition",
      `inline; filename=Tax-Invoice-${invoice.invoiceNumber}.pdf`
    );
